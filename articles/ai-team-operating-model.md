...
repo -- every one a real PR through CI -- while we spent the week at product altitude.
That's an ordinary active week, not a stunt: the model has been running in sprints like
it for months. What follows is the structure that makes it hold: the roles, the coordination
